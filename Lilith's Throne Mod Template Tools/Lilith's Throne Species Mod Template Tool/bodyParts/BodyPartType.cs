...
namespace LTSMTT.bodyParts
{
    partial class BodyPartType : NestedNode
    {
        ...
        public BodyPartType(string name = null, List<string> availableCoveringTypes=null, string race=null) : base (name, new List<ManagedXmlNode>(), true)
        {
            this.name = name;
        ...
        {
            this.tags.AddStringSubnode("tag", tagName, true);
        }
